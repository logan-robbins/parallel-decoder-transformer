...
and contract-tested. The long-form 32-document paired causal run and dense-14B
scale rung remain empirical work.
...
16. [done] Publish the complete local implementation and documentation worktree, excluding ignored model artifacts and heavyweight generated datasets. 2026-07-16: the current preflight layer passes Ruff, mypy across the 55-file canonical typed surface, and all 253 smoke tests.
