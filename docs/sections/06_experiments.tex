...
A core motivation for SNC is the prohibitive cost of full-model fine-tuning. We empirically mapped the memory requirements of the B200 architecture across our curriculum stages (Figure \ref{fig:memory_cliff}).
